            ...
            <div class="container-main">
                <div class="get-in-touch text-page">
                    ...
                    <div class="editor-content">
                        ...
                        <p>At ASCAN Training, accessible from https://ascantraining.com, one of our main priorities
                            is the privacy of our visitors. This Privacy Policy document contains types of information
                            that is collected and recorded by ASCAN Training and how we use it.</p>
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in ASCAN Training.
                            This policy is not applicable to any information collected offline or via channels other
                            than this website. Our Privacy Policy was created with the help of the Free Privacy Policy
                            Generator.</p>
                        ...
                        <h3>Log Files</h3>
                        <p>ASCAN Training follows a standard procedure of using log files. These files log visitors when
                        ...
                        <p>Like any other website, ASCAN Training uses &#x27;cookies&#x27;. These cookies are used to
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                            Beacons that are used in their respective advertisements and links that appear on ASCAN
                            Training, which are sent directly to users&#x27; browser. They automatically receive your IP
                        ...
                        <p>Note that ASCAN Training has no access to or control over these cookies that are used by
                            third-party advertisers.</p>


                        <h3>Third Party Privacy Policies</h3>
                        <p>ASCAN Training&#x27;s Privacy Policy does not apply to other advertisers or websites. Thus,
                        ...
                        <ul>
                            <li>Request that a business that collects a consumer's personal data disclose the categories
                                and specific pieces of personal data that a business has collected about consumers.</li>
                        ...
                        <p>ASCAN Training does not knowingly collect any Personal Identifiable Information from children
